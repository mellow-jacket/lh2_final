...
def main():
    ...
    print("  - Initial pressure: 1.5 bar (slightly above atmospheric)")
    print("  - Initial temperature: 20.5 K (saturated)")
    print("  - Vent opens when pressure exceeds 1.4 bar")
    print("  - Environmental heat leak: 150 W total")
    print("\nPhysics Focus:")
